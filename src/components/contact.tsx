          ...
          >
            ...
            <div className="mt-12">
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="bg-secondary hover:bg-primary hover:text-primary-foreground rounded-full p-3 transition-colors"
                  aria-label="GitHub"
                >
                  <svg
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="bg-primary text-primary-foreground hover:bg-primary/90 flex w-full items-center justify-center rounded-md px-8 py-3 transition-colors disabled:opacity-70"
              >
                {isSubmitting ? (
                  <span>Sending...</span>
                ) : (
              ...
              {submitStatus === "success" && (
                <div className="rounded-md bg-green-100 p-4 text-green-800 dark:bg-green-900 dark:text-green-100">
                  Your message has been sent successfully!
                </div>
              )}

              {submitStatus === "error" && (
                <div className="rounded-md bg-red-100 p-4 text-red-800 dark:bg-red-900 dark:text-red-100">
